...
{$ENDIF}
  ...
  // Ìèð, â êîòîðîì äåéñòâóþò ïåðñîíàæè
  WORLD_WIDTH = 5;           // 5 êîìíàò = øèðèíà ìèðà
  WORLD_HEIGHT = 4;          // 4 êîìíàòû = âûñîòà ìèðà
  // Íàèáîëüøèå ðàçìåðû êîìíàò
  ROOM_WIDTH = 20;           // 20 ìåñò ïî øèðèíå êîìíàòû
  ROOM_HEIGHT = 10;          // 20 ìåñò ïî âûñîòå êîìíàòû
  //
...
implementation
// -----------------------------------
// Ïðîèíèöèàëèçèðîâàòü òåêóùóþ êîìíàòó
// -----------------------------------
...
begin
  ...
  // Ïîêàçûâàåì ðàçìåðû èãðîâîãî ïîëÿ
